...
An *intent* could be purchasing a subscription or updating a users' payment method. For a full list of possible intents, please refer to the [API documentation](/api/gigs-connect/connect-sessions/create-a-connect-session) or the dedicated sections about intents in this guide.
