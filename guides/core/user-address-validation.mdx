...
User addresses are always validated when they're submitted to the [address creation endpoint](/api/core/user-addresses#create-a-user-address) on the Gigs API. Typically, basic checks are performed, such as:
...
## [Prerequisites](/api/guides/core/user-address-validation#prerequisites)
...
## [Examples](/api/guides/core/user-address-validation#examples)

All examples use the [address creation endpoint](/api/core/user-addresses#create-a-user-address) to add an address for a user with id `USER_ID`. As explained in the [error handling guide](/api/error-handling), all error responses contain a machine-readable `code` field, and a human-readable description in `message`.
...
You can see the full error schema in the [address creation endpoint reference](/api/core/user-addresses#create-a-user-address). Below we give more concrete examples of address validation errors.

### [Missing required information](/api/guides/core/user-address-validation#missing-required-information)
...
### [Partially correct fields](/api/guides/core/user-address-validation#partially-correct-fields)
...
### [Missing secondary information](/api/guides/core/user-address-validation#missing-secondary-information)
...
## [Support](/api/guides/core/user-address-validation#support)
