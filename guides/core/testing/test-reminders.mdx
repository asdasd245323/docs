...
Test providers use accelerated threshold schedules for faster testing. The same threshold patterns apply as shown in the [table](/guides/core/reminders#how-they-work), but time intervals are measured in **minutes instead of days**. For example, "Day 1" becomes "Minute 1".
