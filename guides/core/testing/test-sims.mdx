...
## [How to Use Test SIMs](/api/guides/core/testing/test-sims#how-to-use-test-sims)

The following Gigs API endpoints support the use of test SIMs:

- [Create a subscription](/api/guides/create-subscription)
- [Create a device](/api/gig-core-api/devices/create)
- [Update a device](/api/gig-core-api/devices/update)
- [Search for SIMs](/api/guides/core/sims)
...
To find the placeholder SIMs, you can search for them using the [SIM search endpoint](/api/guides/core/sims#search-for-sims) with the fixed ICCIDs, for example looking up the placeholder `eSIM` - `8942400090000000010`:
...
## [Overview of Test SIMs](/api/guides/core/testing/test-sims#overview-of-test-sims)
