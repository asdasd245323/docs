...
description: "Fired when a porting is in requested state for a prolonged period so the user can check status with porting's donor provider."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.reminder.porting.requested`.

  Allowed values: `com.gigs.reminder.porting.requested`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.reminder.porting.requested",
  "version": "2026-01-29"
}
```
</RequestExample>
