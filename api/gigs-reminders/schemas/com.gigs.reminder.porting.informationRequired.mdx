...
description: "Fired when a porting request requires additional missing information from the user."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.reminder.porting.informationRequired`.

  Allowed values: `com.gigs.reminder.porting.informationRequired`
</ResponseField>
