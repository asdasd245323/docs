...
description: "Fired when an eSIM has been assigned but it is not yet installed on the user's device. Only available for providers that support eSIM lifecycle events (p3, p11, p14, p15)."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.reminder.subscription.simNotInstalled`.

  Allowed values: `com.gigs.reminder.subscription.simNotInstalled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.reminder.subscription.simNotInstalled",
  "version": "2026-01-29"
}
```
</RequestExample>
