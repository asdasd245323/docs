...
description: "Fired when a porting request has been declined and the user needs to correct the provided information and resubmit."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.reminder.porting.declined`.

  Allowed values: `com.gigs.reminder.porting.declined`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.reminder.porting.declined",
  "version": "2026-01-29"
}
```
</RequestExample>
