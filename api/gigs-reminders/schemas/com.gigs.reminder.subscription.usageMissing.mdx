...
description: "Fired when an eSIM is installed but no usage has been detected after activation. Only available for providers that support eSIM lifecycle events (p3, p11, p14, p15)."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.reminder.subscription.usageMissing`.

  Allowed values: `com.gigs.reminder.subscription.usageMissing`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.reminder.subscription.usageMissing",
  "version": "2026-01-29"
}
```
</RequestExample>
