...
description: "Event fired when an add-on is archived."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.addon.archived`.

  Allowed values: `com.gigs.addon.archived`
</ResponseField>
