...
description: "Event fired when a credit note is voided."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.creditNote.voided`.

  Allowed values: `com.gigs.creditNote.voided`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.creditNote.voided",
  "version": "2026-01-29"
}
```
</RequestExample>
