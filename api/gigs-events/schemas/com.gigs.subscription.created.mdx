...
description: "Fired when a new subscription has been created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.created`.

  Allowed values: `com.gigs.subscription.created`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.created",
  "version": "2026-01-29"
}
```
</RequestExample>
