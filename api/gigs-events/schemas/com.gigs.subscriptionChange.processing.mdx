...
description: "Fired when a subscription change is currently being processed."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionChange.processing`.

  Allowed values: `com.gigs.subscriptionChange.processing`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionChange.processing",
  "version": "2026-01-29"
}
```
</RequestExample>
