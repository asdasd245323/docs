...
description: "Event fired when a port out is completed."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.completed`.

  Allowed values: `com.gigs.portOut.completed`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.portOut.completed",
  "version": "2026-01-29"
}
```
</RequestExample>
