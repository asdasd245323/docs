...
description: "Event fired when an add-on is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.addon.created`.

  Allowed values: `com.gigs.addon.created`
</ResponseField>
