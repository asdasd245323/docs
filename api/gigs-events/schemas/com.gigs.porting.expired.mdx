...
description: "Event fired when a porting is expired."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.porting.expired`.

  Allowed values: `com.gigs.porting.expired`
</ResponseField>
