...
description: "Fired when a subscription add-on has ended."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionAddon.ended`.

  Allowed values: `com.gigs.subscriptionAddon.ended`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionAddon.ended",
  "version": "2026-01-29"
}
```
</RequestExample>
