...
description: "Event fired when a port out is failed."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.failed`.

  Allowed values: `com.gigs.portOut.failed`
</ResponseField>
