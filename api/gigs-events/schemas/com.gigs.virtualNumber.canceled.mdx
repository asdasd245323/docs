...
description: "Fired when a virtual number has been canceled."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.virtualNumber.canceled`.

  Allowed values: `com.gigs.virtualNumber.canceled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.virtualNumber.canceled",
  "version": "2026-01-29"
}
```
</RequestExample>
