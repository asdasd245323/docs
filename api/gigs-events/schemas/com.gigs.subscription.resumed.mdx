...
description: "Fired when a paused subscription has been resumed."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.resumed`.

  Allowed values: `com.gigs.subscription.resumed`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.resumed",
  "version": "2026-01-29"
}
```
</RequestExample>
