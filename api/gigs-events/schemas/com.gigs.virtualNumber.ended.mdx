...
description: "Fired when a virtual number has ended."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.virtualNumber.ended`.

  Allowed values: `com.gigs.virtualNumber.ended`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.virtualNumber.ended",
  "version": "2026-01-29"
}
```
</RequestExample>
