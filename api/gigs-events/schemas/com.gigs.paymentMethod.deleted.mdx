...
description: "Event fired when a payment method is deleted."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.paymentMethod.deleted`.

  Allowed values: `com.gigs.paymentMethod.deleted`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.paymentMethod.deleted",
  "version": "2026-01-29"
}
```
</RequestExample>
