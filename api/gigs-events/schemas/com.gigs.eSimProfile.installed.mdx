...
description: "Fires when the eSIM profile is installed on a device. Only available for providers `p3`, `p11`, `p12`, `p14` and `p15`."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.eSimProfile.installed`.

  Allowed values: `com.gigs.eSimProfile.installed`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.eSimProfile.installed",
  "version": "2026-01-29"
}
```
</RequestExample>
