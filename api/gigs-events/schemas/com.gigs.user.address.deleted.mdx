...
description: "Fired when a user address has been deleted."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.user.address.deleted`.

  Allowed values: `com.gigs.user.address.deleted`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.user.address.deleted",
  "version": "2026-01-29"
}
```
</RequestExample>
