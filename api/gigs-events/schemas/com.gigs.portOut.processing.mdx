...
description: "Event fired when a port out is processing."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.processing`.

  Allowed values: `com.gigs.portOut.processing`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.portOut.processing",
  "version": "2026-01-29"
}
```
</RequestExample>
