...
description: "Fired when a voucher has been created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.voucher.created`.

  Allowed values: `com.gigs.voucher.created`
</ResponseField>
