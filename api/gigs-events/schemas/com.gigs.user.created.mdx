...
description: "Fired when a new user account has been created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.user.created`.

  Allowed values: `com.gigs.user.created`
</ResponseField>
