...
description: "Event fired when a payment succeeds."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.payment.succeeded`.

  Allowed values: `com.gigs.payment.succeeded`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.payment.succeeded",
  "version": "2026-01-29"
}
```
</RequestExample>
