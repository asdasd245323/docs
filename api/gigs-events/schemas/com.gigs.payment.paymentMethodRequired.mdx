...
description: "Event fired when a payment requires a payment method."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.payment.paymentMethodRequired`.

  Allowed values: `com.gigs.payment.paymentMethodRequired`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.payment.paymentMethodRequired",
  "version": "2026-01-29"
}
```
</RequestExample>
