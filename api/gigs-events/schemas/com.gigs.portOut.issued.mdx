...
description: "Event fired when a port out is issued."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.issued`.

  Allowed values: `com.gigs.portOut.issued`
</ResponseField>
