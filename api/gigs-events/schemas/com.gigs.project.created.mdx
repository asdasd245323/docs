...
description: "Event fired when a project is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.project.created`.

  Allowed values: `com.gigs.project.created`
</ResponseField>
