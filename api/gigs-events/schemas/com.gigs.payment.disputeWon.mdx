...
description: "Event fired when a payment dispute is won."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.payment.disputeWon`.

  Allowed values: `com.gigs.payment.disputeWon`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.payment.disputeWon",
  "version": "2026-01-29"
}
```
</RequestExample>
