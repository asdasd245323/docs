...
description: "Event fired when a plan is published."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.plan.published`.

  Allowed values: `com.gigs.plan.published`
</ResponseField>
