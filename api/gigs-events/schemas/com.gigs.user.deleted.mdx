...
description: "Fired when a user account has been permanently deleted."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.user.deleted`.

  Allowed values: `com.gigs.user.deleted`
</ResponseField>
