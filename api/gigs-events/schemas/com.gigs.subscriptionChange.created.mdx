...
description: "Fired when a new subscription change has been created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionChange.created`.

  Allowed values: `com.gigs.subscriptionChange.created`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionChange.created",
  "version": "2026-01-29"
}
```
</RequestExample>
