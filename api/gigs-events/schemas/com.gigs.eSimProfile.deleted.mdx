...
description: "Fires when the eSIM profile is deleted. Only available for providers `p3`, `p14` and `p15`."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.eSimProfile.deleted`.

  Allowed values: `com.gigs.eSimProfile.deleted`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.eSimProfile.deleted",
  "version": "2026-01-29"
}
```
</RequestExample>
