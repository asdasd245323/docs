...
description: "Fires when the eSIM profile is enabled. Only available for providers `p3`, `p12`, `p14` and `p15`."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.eSimProfile.enabled`.

  Allowed values: `com.gigs.eSimProfile.enabled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.eSimProfile.enabled",
  "version": "2026-01-29"
}
```
</RequestExample>
