...
description: "Event fired when a porting is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.porting.created`.

  Allowed values: `com.gigs.porting.created`
</ResponseField>
