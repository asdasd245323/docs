...
description: Triggered when an invoice becomes overdue and the overdue period starts.
---
...
<ResponseField name="type" type="string" required>
  Type is always `com.gigs.invoice.overdue`.

  Allowed values: `com.gigs.invoice.overdue`
</ResponseField>
