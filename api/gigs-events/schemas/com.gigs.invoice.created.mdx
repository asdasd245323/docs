...
description: Schema for the com.gigs.invoice.created event.
---
...
<ResponseField name="type" type="string" required>
  Type is always `com.gigs.invoice.created`.

  Allowed values: `com.gigs.invoice.created`
</ResponseField>
