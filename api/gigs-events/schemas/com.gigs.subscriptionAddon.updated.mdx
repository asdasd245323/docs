...
description: "Fired when one or more fields on a subscription add-on have been updated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionAddon.updated`.

  Allowed values: `com.gigs.subscriptionAddon.updated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionAddon.updated",
  "version": "2026-01-29",
  "previousData": {}
}
```
