...
description: "Fired when a subscription add-on has been renewed for a new billing period."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionAddon.renewed`.

  Allowed values: `com.gigs.subscriptionAddon.renewed`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionAddon.renewed",
  "version": "2026-01-29"
}
```
</RequestExample>
