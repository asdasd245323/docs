...
description: "Event fired when an installation is updated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.installation.updated`.

  Allowed values: `com.gigs.installation.updated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.installation.updated",
  "version": "2026-01-29"
}
```
</RequestExample>
