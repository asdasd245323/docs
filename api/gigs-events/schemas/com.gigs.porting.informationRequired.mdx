...
description: "Event fired when information is required for a porting."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.porting.informationRequired`.

  Allowed values: `com.gigs.porting.informationRequired`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.porting.informationRequired",
  "version": "2026-01-29"
}
```
</RequestExample>
