...
description: Triggered 3 days before an invoice will become overdue if it is not paid by then.
---
...
<ResponseField name="type" type="string" required>
  Type is always `com.gigs.invoice.willBeOverdue`.

  Allowed values: `com.gigs.invoice.willBeOverdue`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.invoice.willBeOverdue",
  "version": "2026-01-29"
}
```
</RequestExample>
