...
description: "Fired when a subscription has been canceled. The subscription will remain active until the end of the current period."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.canceled`.

  Allowed values: `com.gigs.subscription.canceled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.canceled",
  "version": "2026-01-29"
}
```
</RequestExample>
