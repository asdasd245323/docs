...
description: "Event fired when a device is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.device.created`.

  Allowed values: `com.gigs.device.created`
</ResponseField>
