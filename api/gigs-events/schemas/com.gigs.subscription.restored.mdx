...
description: "Fired when a previously restricted subscription has been restored to full service."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.restored`.

  Allowed values: `com.gigs.subscription.restored`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.restored",
  "version": "2026-01-29"
}
```
</RequestExample>
