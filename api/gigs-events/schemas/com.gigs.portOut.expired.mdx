...
description: "Event fired when a port out is expired."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.expired`.

  Allowed values: `com.gigs.portOut.expired`
</ResponseField>
