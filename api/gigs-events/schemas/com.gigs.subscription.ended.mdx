...
description: "Fired when a subscription has ended and connectivity is no longer provided."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.ended`.

  Allowed values: `com.gigs.subscription.ended`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.ended",
  "version": "2026-01-29"
}
```
</RequestExample>
