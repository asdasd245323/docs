...
description: Triggered when an invoice is finalized and becomes due for payment.
---
...
<ResponseField name="type" type="string" required>
  Type is always `com.gigs.invoice.finalized`.

  Allowed values: `com.gigs.invoice.finalized`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.invoice.finalized",
  "version": "2026-01-29"
}
```
</RequestExample>
