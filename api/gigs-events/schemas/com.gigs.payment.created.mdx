...
description: "Event fired when a payment is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.payment.created`.

  Allowed values: `com.gigs.payment.created`
</ResponseField>
