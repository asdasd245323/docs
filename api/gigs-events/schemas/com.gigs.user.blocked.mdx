...
description: "Fired when a user has been blocked and can no longer access the service."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.user.blocked`.

  Allowed values: `com.gigs.user.blocked`
</ResponseField>
