...
description: "Event fired when a Connect session is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.connectSession.created`.

  Allowed values: `com.gigs.connectSession.created`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.connectSession.created",
  "version": "2026-01-29"
}
```
</RequestExample>
