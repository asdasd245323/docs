...
description: "Fires when the eSIM profile is disabled. Note that if the eSIM being disabled results in the device losing connectivity, this event will be delayed until connectivity is regained.\n\nOnly available for providers `p3`, `p14` and `p15`."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.eSimProfile.disabled`.

  Allowed values: `com.gigs.eSimProfile.disabled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.eSimProfile.disabled",
  "version": "2026-01-29"
}
```
</RequestExample>
