...
description: "Event fired when a port out is updated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.portOut.updated`.

  Allowed values: `com.gigs.portOut.updated`
</ResponseField>
