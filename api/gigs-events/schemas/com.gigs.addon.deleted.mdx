...
description: "Event fired when an add-on is deleted."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.addon.deleted`.

  Allowed values: `com.gigs.addon.deleted`
</ResponseField>
