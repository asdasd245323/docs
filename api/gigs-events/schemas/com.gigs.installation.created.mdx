...
description: "Event fired when an installation is created."
---
...
<ResponseField name="data" type="Installation">
</ResponseField>
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.installation.created`.

  Allowed values: `com.gigs.installation.created`
</ResponseField>
...
```json Example
{
  ...
  "data": {
    "object": "installation",
    "application": "gigs-connect",
    "createdAt": "2022-01-21T19:38:34.0Z",
    "settings": {}
  },
  ...
  "type": "com.gigs.installation.created",
  "version": "2026-01-29"
}
```
</RequestExample>
