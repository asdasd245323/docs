...
description: "Fired when a virtual number has been updated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.virtualNumber.updated`.

  Allowed values: `com.gigs.virtualNumber.updated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.virtualNumber.updated",
  "version": "2026-01-29"
}
```
</RequestExample>
