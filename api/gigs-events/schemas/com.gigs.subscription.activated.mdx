...
description: "Fired when a subscription has been activated and connectivity is now enabled for the user."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.activated`.

  Allowed values: `com.gigs.subscription.activated`
</ResponseField>
