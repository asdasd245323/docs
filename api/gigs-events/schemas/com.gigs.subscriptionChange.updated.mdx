...
description: "Fired when one or more fields on a subscription change have been updated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionChange.updated`.

  Allowed values: `com.gigs.subscriptionChange.updated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionChange.updated",
  "version": "2026-01-29",
  "previousData": {}
}
```
