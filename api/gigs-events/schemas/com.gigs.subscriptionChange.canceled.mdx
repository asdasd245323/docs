...
description: "Fired when a scheduled subscription change has been canceled before taking effect."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionChange.canceled`.

  Allowed values: `com.gigs.subscriptionChange.canceled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionChange.canceled",
  "version": "2026-01-29"
}
```
</RequestExample>
