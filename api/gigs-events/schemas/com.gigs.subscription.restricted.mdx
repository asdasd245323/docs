...
description: "Fired when a subscription has been restricted, limiting connectivity based on the configured behavior."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscription.restricted`.

  Allowed values: `com.gigs.subscription.restricted`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscription.restricted",
  "version": "2026-01-29"
}
```
</RequestExample>
