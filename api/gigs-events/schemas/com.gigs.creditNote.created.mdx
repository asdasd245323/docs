...
description: "Event fired when a credit note is created."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.creditNote.created`.

  Allowed values: `com.gigs.creditNote.created`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.creditNote.created",
  "version": "2026-01-29"
}
```
</RequestExample>
