...
description: "Event fired when a porting is failed."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.porting.failed`.

  Allowed values: `com.gigs.porting.failed`
</ResponseField>
