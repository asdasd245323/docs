...
description: "Fired when a pending subscription change has been activated and applied."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.subscriptionChange.activated`.

  Allowed values: `com.gigs.subscriptionChange.activated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.subscriptionChange.activated",
  "version": "2026-01-29"
}
```
</RequestExample>
