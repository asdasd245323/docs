...
description: "Fired when a virtual number has been activated."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.virtualNumber.activated`.

  Allowed values: `com.gigs.virtualNumber.activated`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.virtualNumber.activated",
  "version": "2026-01-29"
}
```
</RequestExample>
