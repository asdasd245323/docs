...
description: "Event fired when a porting is canceled."
---
...
<ResponseField name="type" type="string">
  Type is always `com.gigs.porting.canceled`.

  Allowed values: `com.gigs.porting.canceled`
</ResponseField>
...
```json Example
{
  ...
  "type": "com.gigs.porting.canceled",
  "version": "2026-01-29"
}
```
</RequestExample>
